...
LABEL = "biomart-v01"
SPECIES_LIST = ["cejohnprjeb47283", "trtricprjeb535",'trribeprjna953805']  # trial set
...
def main():
    ...
    # Update counts (and headers) in run.json
    from populateGeneList_2 import HEADER_AUDIT  # already imported via *, but explicit is fine
    ...
    # append header audit captured inside populateGeneList_2.retrieveGeneListFromWbpBiomart
    meta["headers"] = {**meta.get("headers", {}), **HEADER_AUDIT}
    ...
    meta_path.write_text(json.dumps(meta, indent=2), encoding="utf-8")
    print("[info] Phase 1B complete — multi-species export written.")
